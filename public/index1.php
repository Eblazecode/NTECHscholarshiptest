                    ...
                    <div class="uk-width-expand@m uk-flex uk-flex-middle uk-light">
                        <div>
                            ...
                            <h1 class="uk-heading-small uk-letter-spacing-medium">
                                <a class="uk-navbar-item uk-logo" href="index1.php"><img src="img/NTECH%20PNG-01.png" width="80px"></a>
                                N-TECH ICT
                                Scholarship  2021</h1>
                            <p class="uk-margin-small-bottom">The last and final batch of examination
                                comes up on the 28th August, 2021. NO MORE RESCHEDULING!</p>
                            ...
                            <div class="uk-rating">
                                <div><a class="uk-button uk-button-primary-preserve
                                 uk-button-large uk-width-1-1@m" href="#instruction"
                                        style="background-color: purple" > Thank you ! </a></div>
                            </div>
                        </div>
                    </div>
                </div>
